                                  ...
                                  const double boardVar, const double alphaVar)
{
   ...
   if (dcarm == 0) // DCe
   {
      if (zDC >= 0)
      {
         ...
         if (xBinX1Max >= static_cast<short>(cutAreasDCe0X1.size())) 
            xBinX1Max = static_cast<short>(cutAreasDCe0X1.size()) - 1;
         if (yBinX2Max >= static_cast<short>(cutAreasDCe0X2.size())) 
            yBinX2Max = static_cast<short>(cutAreasDCe0X2.size()) - 1;
         if (xBinX2Max >= static_cast<short>(cutAreasDCe0X2.size())) 
            xBinX2Max = static_cast<short>(cutAreasDCe0X2.size()) - 1;
      ...
      else
      {
         ...
         if (xBinX1Max >= static_cast<short>(cutAreasDCe1X1.size())) 
            xBinX1Max = static_cast<short>(cutAreasDCe1X1.size()) - 1;
         if (yBinX2Max >= static_cast<short>(cutAreasDCe1X2.size())) 
            yBinX2Max = static_cast<short>(cutAreasDCe1X2.size()) - 1;
         if (xBinX2Max >= static_cast<short>(cutAreasDCe1X2.size())) 
            xBinX2Max = static_cast<short>(cutAreasDCe1X2.size()) - 1;
   ...
   if (zDC >= 0)
   {
      ...
      if (xBinX1Max >= static_cast<short>(cutAreasDCw0X1.size())) 
         xBinX1Max = static_cast<short>(cutAreasDCw0X1.size()) - 1;
      if (yBinX2Max >= static_cast<short>(cutAreasDCw0X2.size())) 
         yBinX2Max = static_cast<short>(cutAreasDCw0X2.size()) - 1;
      if (xBinX2Max >= static_cast<short>(cutAreasDCw0X2.size())) 
         xBinX2Max = static_cast<short>(cutAreasDCw0X2.size()) - 1;
   ...
   else
   {
      ...
      if (xBinX1Max >= static_cast<short>(cutAreasDCw1X1.size())) 
         xBinX1Max = static_cast<short>(cutAreasDCw1X1.size()) - 1;
      if (yBinX2Max >= static_cast<short>(cutAreasDCw1X2.size())) 
         yBinX2Max = static_cast<short>(cutAreasDCw1X2.size()) - 1;
      if (xBinX2Max >= static_cast<short>(cutAreasDCw1X2.size())) 
         xBinX2Max = static_cast<short>(cutAreasDCw1X2.size()) - 1;
