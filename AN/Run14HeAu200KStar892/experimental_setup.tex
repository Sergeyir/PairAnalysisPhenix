...
\begin{equation}
\text{chamber}_{\text{TOFe}} = \text{slat}_{\text{cnt}}/96, \ \text{slat}_{\text{TOFe}} = \text{slat}_{\text{cnt}} \ \% \ 96
\end{equation}
\begin{equation}
\text{chamber}_{\text{TOFw}} = \text{strip}_{\text{cnt}}/64, \ \text{strip}_{\text{TOFw}} = \text{strip}_{\text{cnt}} \ \% \ 64
\end{equation}
