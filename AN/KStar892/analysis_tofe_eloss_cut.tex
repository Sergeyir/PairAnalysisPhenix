...
\begin{figure}[h!]
   ...
   \begin{subfigure}{0.45\textwidth}
      ...
      \subcaption{}
   \end{subfigure}
   \caption[$\beta$ vs $E_{\text{loss}}$ distributions and $E_{\text{loss}}$ cut]
   {$\beta$ vs $E_{\text{loss}}$ distributions and $E_{\text{loss}}$ cut (red line) for real data (a) and for MC (b)}
   \label{fig:eloss_cut}
\end{figure}
