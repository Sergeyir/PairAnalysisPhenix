...
\begin{table}[h!]
	...
	\begin{tabular}{c||c|c|c|c|c|c}
      \multirow{2}{*}{Detector} & \multicolumn{3}{|c|}{TOFe} & \multicolumn{3}{|c}{TOFw} \\
      \cline{2-7} & $\sigma_{\alpha}$ & $\sigma_{ms}$ & $\sigma_t$ & $\sigma_{\alpha}$ & $\sigma_{ms}$ & $\sigma_t$ \\
      \hline
      \hline
      Run14 \HeAu & \multirow{3}{*}{0.9} & \multirow{3}{*}{1} & \multirow{3}{*}{150} & \multirow{3}{*}{0.9} & \multirow{3}{*}{1} & 94 \\
      \cline{0-0} \cline{7-7} Run15 \pAl & & & & & & \multirow{2}{*}{145}\\
     \cline{0-0} Run15 \pAu & & & & & & \\
	\end{tabular}
