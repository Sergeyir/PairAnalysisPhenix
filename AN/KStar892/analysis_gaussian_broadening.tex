...
These approximations ($\sigma_{\text{gb}}$) were used to estimate the gaussian broadening in real data for different $p_T$ bins.
...
\begin{figure}[h!]
   ...
   \hfill
   \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\textwidth]{GaussianBroadening/Run15pAl200/KStar892_1.0-1.2.pdf}
      \subcaption{}
   \end{subfigure}
   \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\textwidth]{GaussianBroadening/Run15pAu200/KStar892_1.0-1.2.pdf}
      \subcaption{}
   \end{subfigure}
...
\begin{figure}[h!]
   ...
   \hfill
   \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\textwidth]{GaussianBroadening/Run15pAl200/KStar892_sigmas.pdf}
      \subcaption{}
   \end{subfigure}
   \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\textwidth]{GaussianBroadening/Run15pAu200/KStar892_sigmas.pdf}
      \subcaption{}
   \end{subfigure}
