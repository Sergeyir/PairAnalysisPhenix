...
void DrawRCP() 
{
	...
	*/
	...
	rcp.AddGraph("../ext/RCP/AuAu200/proton_0010_4060.txt",	
		...
		"0-10/40-60 p+#bar{p}", kSpring+5, 59,
		ptmin, ptmax);
	...
	rcp.AddGraph("../ext/Spectra/AuAu200/phi1020_0-10.txt",
		...
		"0-10/40-60 #varphi(1020)", kAzure+2, 55, 
	...
	rcp.PrintTable("../output/Tables/RCP/" + Par.run + "/" + Par.runnum + "/KStar892_" + 
